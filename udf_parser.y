...
stmt : expr ';'                         { $$ = new udf::evaluation_node(LINE, $1); }
     | tWRITE expr ';'                  { $$ = new udf::write_node(LINE, new cdk::sequence_node(LINE, $2)); }
     | tINPUT lval ';'                   { $$ = new udf::input_node(LINE); }
     | tFOR '(' stmts ';' expr_opt ';' stmts ')' stmt { $$ = new udf::for_node(LINE, $3, $5, $7, $9); }
